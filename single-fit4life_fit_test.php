                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post' ); ?>>
                    ...
                    <div class="fit_test_form">
                        ...
                        <form id="fit_test_results_form" name="fit_test_results_form" class="fit_test_results_update" method="post">
                            ...
                            // get raw date
                            $start_date = get_field('fit4life_test_start_date', false, false);
                            $end_date = get_field('fit4life_test_end_date', false, false);
                            ...
                            <div id="fit_test_header">
                                <div id="fit_test_info">
                                    ...
                                    <?php the_field('fit4life_performance_test_instructions'); ?>
                                </div>
                            ...
                            <div class="movement_perf_content">
                                ...
                                <?php
                                if( have_rows('fit4life_movement_performance_tests') ):
                                    $has_tests = true;
                                ?>

                                    <!-- loop through rows (fit-test movement performance rows) -->
                                    <?php while( have_rows('fit4life_movement_performance_tests') ): the_row(); ?>

                                        <?php  // vars

                                            $video_link = get_sub_field('fit4life_movement_video_id');
                                            $checked = '';
                                            $can_you_perform = get_sub_field('fit4life_can_you_perform', false);
                                        ...
                                        <div class="movement_perf_details">
                                            ...
                                            <?php the_sub_field('fit4life_movement_exercise_name'); ?>
                                            ...
                                            <input type="checkbox" name="fit4life_can_you_perform[]" value="<?php echo $row_index; ?>" <?php echo $checked; ?>/>
                                        </div>
                            ...
                            <div class="max_perf_content">
                                ...
                                <?php if( have_rows('fit4life_maximum_performance_tests') ): ?>

                                    <!-- loop through rows (fit-test maximum performance rows) -->
                                    <?php $max_test_number = 0; ?>
                                    <?php while( have_rows('fit4life_maximum_performance_tests') ): the_row(); ?>

                                        <?php  // vars
                                        $max_test_number++;
                                        $max_video_link = get_sub_field('fit4life_maximum_performance_video_id');
                                        ?>

                                        <div class="max_perf_details">
                                            <strong>Test #<?php echo $max_test_number; ?>: </strong>
                                            <?php the_sub_field('fit4life_max_performance_exercise_name'); ?>
                                            ...
                                            <?php the_sub_field('fit4life_maximum_performance_test_instructions'); ?>

                                            <div id="fit_test_value_container">
                                                <div id="fit_test_start_value">
                                                    <strong>Starting Value: </strong><input class="fit_test_results_input" type="text" name="starting_value[]" value="<?php the_sub_field('fit4life_starting_value'); ?>" size="20" />
                                                </div>

                                                <div id="fit_test_end_value">
                                                    <strong>Ending Value: </strong><input class="fit_test_results_input" type="text" name="ending_value[]" value="<?php the_sub_field('fit4life_ending_value'); ?>" size="20" />
                                                </div>
                                            </div>
                            ...
                            <div id="coach-notes">
                                ...
                                <textarea form ="fit_test_results_form" name="coach_notes" id="coach_notes" cols="40" wrap="soft"><?php the_field('fit4life_coach_notes'); ?></textarea>
                            </div>
